  ...
  <div class="panel panel-default">
    ...
    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="panel-body">
       ...
       <div style="position:relative; float: right; width: 40%; margin-left: 40px;" >
        <div class="contactgegevens">
          Wenckebachweg 165<br>
          1096 AM Amsterdam Amstel<br>
          T: 020 - 560 76 66<br>
          F: 020 - 560 76 99<br>
    ...
    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
      <div class="panel-body">
        ...
        <div style="position: relative; width: 100%;" >
          ...
          <div style="position:relative; float: right; width: 40%; margin-left: 40px;" >
            <div class="contactgegevens">
            Laan van Meerestein 12<br>
            1945 TA Beverwijk<br>
            T: (0251) 25 01 75<br>
            F: (0251) 25 18 05<br>
    ...
    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
      <div class="panel-body">
       ...
       <%-- <iframe width="420" height="315"src="https://www.youtube.com/watch?v=nE9eqPM61P4"></iframe> --%> 
    ...
    <div id="collapseNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingNine">
      <div class="panel-body">
        ...
        <div style="position:relative; float: right; width: 40%; margin-left: 40px;" >
          <div class="contactgegevens">
            Nieuwe Havenweg 28<br>
            1216 BT Hilversum<br>
            T: (035) 626 10 61<br>
            F: (035) 626 10 62<br>
    ...
    <div id="collapseTwelve" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwelve">
      ...
      <div style="position: relative; width: 100%;" >
        ...
        <div style="position:relative; float: right; width: 40%; margin-left: 40px;" >
          <div class="contactgegevens">
            Zevenheuvelenweg 20<br>
            Industrienummer 3431<br>
            5048 AN Tilburg<br>
            T: (013) 54 90 180<br>
            F: (013) 54 90 185<br>
