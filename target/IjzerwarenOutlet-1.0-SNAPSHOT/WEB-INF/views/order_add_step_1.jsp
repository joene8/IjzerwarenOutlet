...
<!--<script>
    function checkButton(clickedButton, divID) {
...
<!--                <div id="hidden" style="visibility:hidden;">-->
                <form:form method="POST" class="form-horizontal" role="form" commandName="user" action="${pageContext.request.contextPath}/itemOrder/add_step_1">                    
                    ...
                    <div id="field_streetNumberSuffix" class="form-group <c:if test="${streetNumberSuffixError}">has-error</c:if>">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <form:input type="number" onblur="validate(\"streetNumberSuffix\",/^.*$/)" path="streetNumberSuffix" class="form-control" id="streetNumberSuffix" /> 
