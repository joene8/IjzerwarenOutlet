...
<t:menu>
    <jsp:body>
        ...
        <form:form method="POST" class="form-horizontal" enctype="multipart/form-data" role="form" commandName="product" action="${pageContext.request.contextPath}/product/add">  

            <div id="field_name" class="form-group">
                <label for="name" class="col-sm-2 control-label"><c:if test="${errorName}"></c:if>Name</label>
                    <div class="col-sm-4">
                    <form:input onblur="validate(\"email\",/^\\w+@\\w+\\.\\w{2,}$/)" path="name" class="form-control" id="name" /> 
            ...
            <div id="field_description" class="form-group">
                <label for="description" class="col-sm-2 control-label"><c:if test="${errorDescription}"></c:if>Description</label>
                    <div class="col-sm-4">
                    <form:input onblur="validate(\"email\",/^\\w+@\\w+\\.\\w{2,}$/)" path="description" class="form-control" id="description" /> 
            ...
            <div id="field_additionDescription" class="form-group">
                    ...
                    <div class="col-sm-4">
                        <form:input onblur="validate(\"email\",/^\\w+@\\w+\\.\\w{2,}$/)" path="additionDescription" class="form-control" id="additionDescription" /> 
            ...
            <div id="field_discountPercentage" class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        ...
                        <form:input path="discountPercentage" class="form-control" id="discountPercentage" type="number" step="1"/>
                    </div>
                </div>
            </div>
            ...
            <div id="field_Picture" class="form-group">
                <label for="Picture" class="col-sm-2 control-label"><c:if test="${errorName}"></c:if>Image</label>
                    <div class="col-sm-4">
                    <form:input type ="file" onblur="validate(\"email\",/^\\w+@\\w+\\.\\w{2,}$/)" path="Picture" class="form-control" id="Picture" /> 
